...
import { useState, createContext, useContext, Fragment as Fragment$1, useMemo } from "react";
...
function Sidebar() {
  ...
  return /* @__PURE__ */ jsxs(
    "aside",
    {
      className: `hidden md:flex md:flex-col bg-white border-r border-gray-200 transition-all duration-200 h-screen ${isCollapsed ? "w-16" : "w-64"}`,
      children: [
        ...
        /* @__PURE__ */ jsx("nav", { className: "flex-1 p-3 space-y-1", children: items.map((item) => {
          const isActive = item.label === "Dashboard" && route().current("admin.dashboard");
          return /* @__PURE__ */ jsxs(
            Link,
            {
              href: item.href,
