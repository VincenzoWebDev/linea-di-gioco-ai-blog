...
function buildIntelligence(article, riskThresholds = {}) {
  ...
  const alertLevel = riskScore >= alertHigh ? "Rossa" : riskScore >= alertElevated ? "Arancione" : riskScore >= alertGuarded ? "Gialla" : "Verde";
  const alertClasses = {
  ...
  if (usePopover) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      isOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "fixed bottom-4 inset-x-4 z-50", children: /* @__PURE__ */ jsxs("div", { className: "relative border border-[#D7B56D]/40 bg-[#0B0F15]/95 px-4 py-3 font-mono text-sm text-[#D7DEE8] shadow-2xl shadow-black/40 backdrop-blur", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex h-11 w-11 items-center justify-center rounded-full border border-[#D7B56D]/40 bg-[#D7B56D]/10", children: /* @__PURE__ */ jsx(RadarIcon, {}) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-5 h-64 border border-[#182234] bg-[#0E1116] px-1 py-2 sm:h-80 sm:px-2 sm:py-3", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(
          RadarChart,
          {
...
function ArticlesShow({
  ...
  const metaDescription = article.summary || (() => {
    const excerpt = String(article.content || "").replace(/\s+/g, " ").trim().slice(0, 157);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(BlogLayout, { children: /* @__PURE__ */ jsxs(Tooltip.Provider, { children: [
      /* @__PURE__ */ jsxs("article", { children: [
        ...
        /* @__PURE__ */ jsxs("header", { className: "mt-6 border-b border-[#202A3D] pb-8", children: [
        ...
        article.cover_url && /* @__PURE__ */ jsx("div", { className: "mt-8 overflow-hidden border border-[#202A3D] bg-[#0B0F15]", children: /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[minmax(0,1fr)_minmax(280px,400px)] lg:gap-10 xl:grid-cols-[minmax(0,1fr)_430px]", children: [
          /* @__PURE__ */ jsxs("main", { className: "min-w-0", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-2 break-words text-base sm:text-lg", children: renderContent(article.content, glossary) }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "mt-12 border border-[#202A3D] bg-[#101620] p-4 sm:mt-16 sm:p-6", children: [
        ...
        related.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3", children: related.map((item) => /* @__PURE__ */ jsx(RelatedItem, { article: item }, item.id)) })
      ] })
    ] }) })
  ] });
}
