...
function resolvePage(name) {
  return resolvePageComponent(
    `./Pages/${name}.jsx`,
    /* @__PURE__ */ Object.assign({ "./Pages/Admin/Categories.jsx": () => import("./assets/Categories-CBHHh3n1.mjs"), "./Pages/Admin/Dashboard.jsx": () => import("./assets/Dashboard-Bt8autwx.mjs"), "./Pages/Admin/Media.jsx": () => import("./assets/Media-CG0HmQDV.mjs"), "./Pages/Admin/Pages.jsx": () => import("./assets/Pages-D2UhrYDE.mjs"), "./Pages/Admin/Posts.jsx": () => import("./assets/Posts-DZ4HeTnu.mjs"), "./Pages/Admin/Settings.jsx": () => import("./assets/Settings-C_YcJe9v.mjs"), "./Pages/Admin/Tensions.jsx": () => import("./assets/Tensions-DkXyp3Db.mjs"), "./Pages/Admin/Users.jsx": () => import("./assets/Users-BYcnES6P.mjs"), "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-BmQwph0C.mjs"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-CPd-8fXz.mjs"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-DMxr9fEv.mjs"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-CQ0JFRg2.mjs"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-8SarpTMm.mjs"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-ChTwwVN1.mjs"), "./Pages/Blog/About.jsx": () => import("./assets/About-ChczJPy2.mjs"), "./Pages/Blog/Articles/Index.jsx": () => import("./assets/Index-BHVcWQwm.mjs"), "./Pages/Blog/Articles/Show.jsx": () => import("./assets/Show-Ckvi5eRy.mjs"), "./Pages/Blog/Contact.jsx": () => import("./assets/Contact-Dpwb99-y.mjs"), "./Pages/Blog/Newsletter.jsx": () => import("./assets/Newsletter-kLfXAZaq.mjs"), "./Pages/Legal/CookiePolicy.jsx": () => import("./assets/CookiePolicy-C0yLDHfD.mjs"), "./Pages/Legal/PrivacyPolicy.jsx": () => import("./assets/PrivacyPolicy-DzYIkFKX.mjs"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-JBwqH-br.mjs"), "./Pages/Profile/Partials/DeleteUserForm.jsx": () => import("./assets/DeleteUserForm-Uhkww5qD.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.jsx": () => import("./assets/UpdatePasswordForm-DrpJAyAX.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": () => import("./assets/UpdateProfileInformationForm-DwngIx5O.mjs"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-Cfr1NrVq.mjs") })
  );
}
