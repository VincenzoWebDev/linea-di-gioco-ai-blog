...
function resolvePage(name) {
  return resolvePageComponent(
    `./Pages/${name}.jsx`,
    /* @__PURE__ */ Object.assign({ "./Pages/Admin/Categories.jsx": () => import("./assets/Categories-BueHt5ie.mjs"), "./Pages/Admin/Dashboard.jsx": () => import("./assets/Dashboard-CghDuUc5.mjs"), "./Pages/Admin/Media.jsx": () => import("./assets/Media-CsmuRck6.mjs"), "./Pages/Admin/Pages.jsx": () => import("./assets/Pages-CmNy6dgJ.mjs"), "./Pages/Admin/Posts.jsx": () => import("./assets/Posts-DAuhT57Y.mjs"), "./Pages/Admin/Settings.jsx": () => import("./assets/Settings-vOQyCENs.mjs"), "./Pages/Admin/Tensions.jsx": () => import("./assets/Tensions-BOOZPSnl.mjs"), "./Pages/Admin/Users.jsx": () => import("./assets/Users-CDajgDeA.mjs"), "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-BmQwph0C.mjs"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-CPd-8fXz.mjs"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-DMxr9fEv.mjs"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-CQ0JFRg2.mjs"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-8SarpTMm.mjs"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-ChTwwVN1.mjs"), "./Pages/Blog/Articles/Index.jsx": () => import("./assets/Index-BtKEQn3F.mjs"), "./Pages/Blog/Articles/Show.jsx": () => import("./assets/Show-DyMUeu_N.mjs"), "./Pages/Blog/Contact.jsx": () => import("./assets/Contact-DeO4pACF.mjs"), "./Pages/Blog/Newsletter.jsx": () => import("./assets/Newsletter-3WLvMAE4.mjs"), "./Pages/Legal/CookiePolicy.jsx": () => import("./assets/CookiePolicy-8F8fQFVg.mjs"), "./Pages/Legal/PrivacyPolicy.jsx": () => import("./assets/PrivacyPolicy-Bj8dk6fR.mjs"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-BWiS9YGE.mjs"), "./Pages/Profile/Partials/DeleteUserForm.jsx": () => import("./assets/DeleteUserForm-Uhkww5qD.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.jsx": () => import("./assets/UpdatePasswordForm-DrpJAyAX.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": () => import("./assets/UpdateProfileInformationForm-DwngIx5O.mjs"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-DIzK0Fh5.mjs") })
  );
}
