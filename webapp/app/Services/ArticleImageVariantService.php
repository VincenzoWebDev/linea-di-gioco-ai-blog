...
class ArticleImageVariantService
{
    ...
    private function makeRasterVariant(
        ...
        if ($this->supportsImagickWebp()) {
            return $this->makeImagickVariant($sourceBytes, $sourceMime, $targetWidth, $targetHeight, $quality);
        }

        if ($this->supportsGdWebp()) {
            return $this->makeGdVariant($sourceBytes, $sourceMime, $targetWidth, $targetHeight, $quality);
        }
    ...
    public function diagnostics(): array
    {
        ...
        $imagickFormats = class_exists(\Imagick::class) ? array_map('strtoupper', \Imagick::queryFormats()) : [];
        ...
        return [
            ...
            'imagick_webp_support' => in_array('WEBP', $imagickFormats, true),
    ...
    {
        return $this->supportsImagickWebp() || $this->supportsGdWebp();
    }
